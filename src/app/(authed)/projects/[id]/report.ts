...
export function buildProjectReportHtml(project: any, phases: any[]): string {
...
<body>
  <div class="page">
    <div class="brand">
      ...
      <span class="gen">Project report<br>Generated ${esc(generated)}</span>
    </div>
    ...
    <div class="footer">Confidential · Generated by Pragati · ${esc(ref)} · ${esc(generated)}</div>
  </div>
</body></html>`;
}
...
export function downloadProjectReport(project: any, phases: any[]) {
  triggerDownload(buildProjectReportHtml(project, phases), 'text/html;charset=utf-8',
